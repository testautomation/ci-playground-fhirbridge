...
public class LaboranalytResultatCluster2Containment extends Containment {
  ...
  public SelectAqlField<LaboranalytResultatErgebnisStatusChoiceOrgEhrbaseEhrEncodeWrappersSnakecase4628b1d3> ERGEBNIS_STATUS = new AqlFieldImp<LaboranalytResultatErgebnisStatusChoiceOrgEhrbaseEhrEncodeWrappersSnakecase4628b1d3>(LaboranalytResultatCluster2.class, "/items[at0005]/value", "ergebnisStatus", LaboranalytResultatErgebnisStatusChoiceOrgEhrbaseEhrEncodeWrappersSnakecase4628b1d3.class, this);
  ...
  public SelectAqlField<LaboranalytResultatAnalytResultatChoiceOrgEhrbaseEhrEncodeWrappersSnakecase77cf3f8b> ANALYT_RESULTAT = new AqlFieldImp<LaboranalytResultatAnalytResultatChoiceOrgEhrbaseEhrEncodeWrappersSnakecase77cf3f8b>(LaboranalytResultatCluster2.class, "/items[at0001]/value", "analytResultat", LaboranalytResultatAnalytResultatChoiceOrgEhrbaseEhrEncodeWrappersSnakecase77cf3f8b.class, this);

  public SelectAqlField<LaboranalytResultatProbeChoiceOrgEhrbaseEhrEncodeWrappersSnakecase1df98368> PROBE = new AqlFieldImp<LaboranalytResultatProbeChoiceOrgEhrbaseEhrEncodeWrappersSnakecase1df98368>(LaboranalytResultatCluster2.class, "/items[at0026]/value", "probe", LaboranalytResultatProbeChoiceOrgEhrbaseEhrEncodeWrappersSnakecase1df98368.class, this);
