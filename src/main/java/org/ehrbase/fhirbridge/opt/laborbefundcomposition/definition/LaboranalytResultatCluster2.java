...
public class LaboranalytResultatCluster2 {
  ...
  @Choice
  private LaboranalytResultatErgebnisStatusChoiceOrgEhrbaseEhrEncodeWrappersSnakecase4628b1d3 ergebnisStatus;
  ...
  @Choice
  private LaboranalytResultatAnalytResultatChoiceOrgEhrbaseEhrEncodeWrappersSnakecase77cf3f8b analytResultat;

  @Path("/items[at0026]/value")
  @Choice
  private LaboranalytResultatProbeChoiceOrgEhrbaseEhrEncodeWrappersSnakecase1df98368 probe;
  ...
  public void setErgebnisStatus(
      LaboranalytResultatErgebnisStatusChoiceOrgEhrbaseEhrEncodeWrappersSnakecase4628b1d3 ergebnisStatus) {
     this.ergebnisStatus = ergebnisStatus;
  }

  public LaboranalytResultatErgebnisStatusChoiceOrgEhrbaseEhrEncodeWrappersSnakecase4628b1d3 getErgebnisStatus(
      ) {
  ...
  public void setAnalytResultat(
      LaboranalytResultatAnalytResultatChoiceOrgEhrbaseEhrEncodeWrappersSnakecase77cf3f8b analytResultat) {
     this.analytResultat = analytResultat;
  }

  public LaboranalytResultatAnalytResultatChoiceOrgEhrbaseEhrEncodeWrappersSnakecase77cf3f8b getAnalytResultat(
      ) {
     return this.analytResultat ;
  }

  public void setProbe(
      LaboranalytResultatProbeChoiceOrgEhrbaseEhrEncodeWrappersSnakecase1df98368 probe) {
     this.probe = probe;
  }

  public LaboranalytResultatProbeChoiceOrgEhrbaseEhrEncodeWrappersSnakecase1df98368 getProbe() {
     return this.probe ;
  }
